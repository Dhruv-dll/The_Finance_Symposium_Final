                ...
                <div className="container mx-auto">
                  ...
                  >
                    ...
                    <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
                      ...
                      continues to become more progressive and dynamic, we
                      aspire to become the premier compilation to provide
                      knowledge that delves into the multitudes of finance and
                      management. Ranging from behavioural and personal finance
                      to analyzing market trends and deconstructing economic
                      news and laws, 'FINSIGHT' serves to become a valuable
                      asset in its readers' lives.
                    </p>
                  </motion.div>
