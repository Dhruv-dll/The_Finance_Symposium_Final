    ...
    <div className="min-h-screen">
      ...
      {!showLoader && (
        <>
          ...
          {/* About TFS Section */}
          <motion.section className="py-20 px-6" style={{ backgroundColor }}>
            <div className="container mx-auto">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Illuminating the path to financial excellence through
                  education, innovation, and industry collaboration
                </p>
              </motion.div>
                ...
                {aboutSections.map((section, index) => (
                  ...
                  >
                    <div className="glassmorphism p-8 rounded-2xl border border-border/20 market-glow group-hover:scale-105 transition-all duration-500">
                      <div
                        className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${section.color} mb-6`}
                      >
                        <section.icon className="w-8 h-8 text-white" />
                      </div>

                      <h3 className="text-2xl font-bold mb-4 text-finance-gold">
                        {section.title}
                      </h3>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          {section.stats.map((stat, idx) => (
                            <div key={idx} className="text-center">
                              <div className="text-2xl font-bold text-finance-electric">
                                {stat.value}
                              </div>
                      ...
                      {section.goals && (
                        <div className="space-y-3">
                          {section.goals.slice(0, 2).map((goal, idx) => (
                            <div
                              key={idx}
                              className="p-3 bg-finance-navy-light/50 rounded-lg"
                            >
          ...
          <section className="py-20 px-6 bg-gradient-to-br from-finance-navy-light to-finance-navy">
            <div className="container mx-auto">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Engaging events that connect theory with practical finance
                  insights
                </p>
              </motion.div>
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.8 }}
                >
                  <h3 className="text-3xl font-bold mb-8 text-finance-green">
                    Upcoming Events
                  </h3>
                  <div className="space-y-6">
                    {events.upcoming.map((event, index) => (
                      <div
                        key={index}
                        className="glassmorphism p-6 rounded-xl border border-finance-green/20 market-glow hover:scale-105 transition-all duration-300"
                      >
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            ...
                            <p className="text-finance-electric">
                              {event.date}
                            </p>
                          </div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.8 }}
                >
                  <h3 className="text-3xl font-bold mb-8 text-finance-electric">
                    Past Events
                  </h3>
                  <div className="space-y-6">
                    {events.past.map((event, index) => (
                      <div
                        key={index}
                        className="glassmorphism p-6 rounded-xl border border-finance-electric/20 opacity-80 hover:opacity-100 transition-opacity duration-300"
                      >
                        <h4 className="text-xl font-bold text-finance-gold mb-2">
                          {event.title}
                        </h4>
                        <p className="text-finance-electric mb-2">
                          {event.date}
                        </p>
