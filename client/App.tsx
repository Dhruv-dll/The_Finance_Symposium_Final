    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          {/* Events Routes */}
          <Route path="/events/saturday-sessions" element={
            <PlaceholderPage
          ...
          <Route path="/events/networking" element={
            <PlaceholderPage
          ...
          <Route path="/events/conclave" element={
            <PlaceholderPage
          ...
          <Route path="/sponsors/past" element={
            <PlaceholderPage
              title="Past Sponsors"
          ...
          <Route path="/sponsors/present" element={
            <PlaceholderPage
