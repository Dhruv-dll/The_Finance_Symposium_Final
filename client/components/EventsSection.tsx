...
const pastEvents: EventCard[] = [
  {
    ...
    description: "Weekly learning sessions that bridge theoretical knowledge with practical insights from industry experts.",
    icon: Calendar,
  ...
  },
  {
    ...
    description: "Connect with industry professionals, alumni, and peers in structured networking sessions.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Our premier annual event featuring top industry leaders, workshops, and competitions.",
    icon: Trophy,
...
const upcomingEvents: UpcomingEvent[] = [
  {
    ...
    description: "Explore the future of financial technology with industry pioneers.",
  ...
  },
  {
    ...
    description: "Hands-on workshop on modern investment strategies and portfolio management.",
    registrationLink: "#register",
  ...
  },
  {
    ...
    description: "Connect with TFS alumni working in top financial institutions.",
    registrationLink: "#register",
...
export default function EventsSection() {
  ...
  const TimelineEvent = ({ event, index }: { event: UpcomingEvent; index: number }) => {
    return (
      <motion.div
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-foreground/80 max-w-3xl mx-auto">
            Discover our comprehensive portfolio of financial education events, from intimate learning sessions to grand industry conclaves.
          </p>
        </motion.div>
