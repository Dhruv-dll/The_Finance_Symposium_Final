...
export default function PlaceholderPage({ title, description, category }: PlaceholderPageProps) {
  return (
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="glassmorphism p-12 rounded-2xl border border-finance-gold/20 market-glow">
              ...
              <div className="bg-finance-navy-light/50 border border-finance-gold/20 rounded-xl p-6 mb-8">
                <h3 className="text-lg font-bold text-finance-gold mb-3">Coming Soon!</h3>
                <p className="text-muted-foreground">
                  This page is currently under development. Our team is working hard to bring you 
                  an amazing experience with cutting-edge design and functionality.
                </p>
              </div>
      ...
      <footer className="py-8 px-6 border-t border-finance-gold/20">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center space-x-4 mb-4">
            ...
            <span className="text-finance-gold font-medium">The Finance Symposium</span>
          </div>
