  ...
  const navItems = [
    {
      ...
      hoverIcon: "📊",
      dropdown: [
        { name: "About TFS", href: "/about", icon: "🏛️", description: "Learn about The Finance Symposium" },
        { name: "Meet the Team", href: "/team", icon: "👥", description: "Our dedicated team members" },
      ],
    },
    { 
      name: "EVENTS", 
      ...
      hoverIcon: "📅",
      dropdown: [
        { name: "Saturday Sessions", href: "/events/saturday-sessions", icon: "📚", description: "Weekly learning sessions" },
        { name: "Networking", href: "/events/networking", icon: "🤝", description: "Connect with professionals" },
        { name: "Flagship Conclave", href: "/events/conclave", icon: "🏆", description: "Our main annual event" },
        { type: "separator" },
        { name: "Upcoming Events", href: "/events/upcoming", icon: "📅", description: "See what's coming next" },
      ],
    },
    { 
      name: "Finsight", 
    ...
    },
    {
      ...
      hoverIcon: "💼",
      dropdown: [
        { name: "Past Sponsors", href: "/sponsors/past", icon: "🏛️", description: "Our previous partners" },
        { name: "Present Sponsors", href: "/sponsors/present", icon: "🤝", description: "Current partnerships" },
      ],
    },
    { 
      name: "Contact Us", 
                    ...
                    {item.dropdown ? (
                      <>
                        ...
                        >
                          ...
                          <span className="font-medium relative z-10 group-hover:text-finance-navy">{item.name}</span>
                  ...
                  >
                    {item.dropdown ? (
                        ...
                        <div className="ml-6 space-y-1">
                          {item.dropdown.map((dropdownItem, dropdownIndex) => {
                            ...
                            return (
                              ...
                              >
                                <Link to={dropdownItem.href} className="flex items-center space-x-3 py-2 px-3">
                      ...
                      <Button
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        <Link to={item.href} className="flex items-center space-x-3 py-3 px-4">
                          <item.icon className="w-5 h-5" />
                          <span className="font-medium">{item.name}</span>
