...
import { accurateMarketDataService, AccurateStockData, MarketSentiment, CryptoData, ForexData, safeFormatTimestamp } from "../services/accurateMarketData";
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                >
                  {isMinimized ? <Eye className="w-4 h-4 text-finance-gold" /> : <EyeOff className="w-4 h-4 text-finance-gold" />}
                </motion.button>
                <motion.button
          ...
          {!isMinimized && (
            ...
            >
              ...
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-finance-electric">Market Sentiment</h4>
                <motion.div 
              ...
              {/* Top Performers */}
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-finance-electric">Top Performers</h4>
                <div className="space-y-2">
                  {topPerformers.map((stock, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="font-medium text-finance-gold text-sm">{stock.symbol}</span>
                        <div className="text-right">
                          <div className="text-xs text-foreground">
                            {formatPrice(stock.price, stock.symbol.includes('SENSEX') || stock.symbol.includes('NIFTY') ? '' : '₹')}
                          </div>
              ...
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-finance-electric">Cryptocurrency</h4>
                <div className="space-y-2">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <div>
                            <span className="font-medium text-finance-electric text-sm">{crypto.symbol}</span>
                        ...
                        <div className="text-right">
                          ...
                          <div className={`text-xs ${getChangeColor(crypto.changePercent)}`}>
              ...
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-finance-electric">Forex</h4>
                <div className="space-y-2">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="font-medium text-finance-green text-sm">{forex.pair}</span>
                        </div>
                        <div className="text-right">
                          <div className="text-xs text-foreground">
                            ₹{formatPrice(forex.price)}
                          </div>
                          <div className={`text-xs ${getChangeColor(forex.changePercent)}`}>
              ...
              {/* Economic Calendar */}
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-finance-electric">Economic Calendar</h4>
                <div className="space-y-2">
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <div>
                            <div className="text-xs text-finance-gold font-medium">{event.date}</div>
                            <div className="text-xs text-foreground">{event.event}</div>
                          </div>
                        </div>
                        <div className={`w-2 h-2 rounded-full ${
                          event.impact === 'high' ? 'bg-finance-red' :
                          event.impact === 'medium' ? 'bg-finance-gold' :
                          'bg-finance-green'
                        }`}></div>
                      </div>
                    </motion.div>
